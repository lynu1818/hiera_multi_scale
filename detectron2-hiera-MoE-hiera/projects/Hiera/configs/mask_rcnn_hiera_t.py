...
train.output_dir = "/media/Pluto/andy/detectron2/projects/Hiera/output/mask_rcnn_hiera_t"
train.bottum_up_ckpt = '/media/Pluto/andy/detectron2/projects/Hiera/init_ckpt/hiera_official/mae_hiera_tiny_224-model_state.pth'

...
model.backbone.bottom_up = L(Hiera)(
    model_name = "mae_hiera_base_plus_224",
    img_size=1024,
    embed_dim=112,
    num_heads=2,
    stages=(2, 3, 16, 3),
...
train.output_dir = "/media/Pluto/andy/detectron2/projects/Hiera/output/mask_rcnn_hiera_b_plus"
train.bottum_up_ckpt = '/media/Pluto/andy/detectron2/projects/Hiera/init_ckpt/hiera_official/mae_hiera_base_plus_224.pth'
